...
[🌐 Demo](#demo) • [✨ Fitur](#fitur-utama) • [🚀 Quick Start](#quick-start) • [📚 Dokumentasi](#dokumentasi) • [🤝 Kontribusi](#kontribusi)
...
## ⚠️ 2. Masalah yang Diselesaikan (Problem Statement)
...
| Masalah                                      | Dampak                                                                             |
| -------------------------------------------- | ---------------------------------------------------------------------------------- |
| 📅 **Jadwal Terpisah**                       | Informasi jadwal kuliah tersebar di berbagai tempat (email, WhatsApp, grup kuliah) |
| 📋 **Tugas Tak Terkelola**                   | Deadline tugas mudah terlewatkan karena tidak ada sistem tracking terpusat         |
| 🎯 **Informasi Eksternal Sulit Diakses**     | Kesempatan oprec, lomba, beasiswa sering terlewatkan                               |
| 💬 **Komunikasi Tidak Efektif**              | Sulit mencari jawaban atas pertanyaan akademik karena terbatas pada forum grup     |
| 📱 **Sistem Berbeda untuk Setiap Kebutuhan** | Mahasiswa harus membuka berbagai aplikasi dan platform                             |
| 🔐 **Masalah Akses & Kontrol**               | Tidak ada mekanisme role-based untuk membedakan akses pengguna                     |
...
✅ Tampilkan jadwal per kelas (A, B, C)  
✅ Kalender interaktif  
✅ Export jadwal  
...
✅ Buat & assign tugas  
✅ Deadline tracking  
✅ Filter berdasarkan kelas & status  
...
✅ Q&A antar mahasiswa  
✅ System voting/upvote  
✅ Thread discussions  
✅ Search functionality

#### 🌟 **Fitur Tambahan**

✅ Afirmasi harian motivasi  
...
#### **Step 2️⃣ - Install Root Dependencies**
...
#### **Step 4️⃣ - Install Server Dependencies**
...
#### **Step 5️⃣ - Setup Environment Variables**
...
> 💡 **Tips**: Generate JWT secret yang aman dengan: `node -e "console.log(require('crypto').randomBytes(32).toString('hex'))"`
...
│   ├── src/
│   │   ├── 🎨 components/
│   │   │   ├── common/                 # Komponen yang digunakan berulang kali
│   │   │   ├── layout/                 # Layout wrapper
│   │   │   ├── schedule/               # Komponen jadwal kuliah
│   │   │   ├── assignments/            # Komponen manajemen tugas
│   │   │   ├── activities/             # Komponen kegiatan
│   │   │   ├── forum/                  # Komponen forum diskusi
│   │   │   ├── external-info/          # Komponen info eksternal
...
│   │   ├── 🚦 routes/                  # API routes
│   │   ├── 🛡️ middleware/              # Auth & custom middleware
...
<details>
<summary><b>📝 Assignment Endpoints</b></summary>
...
<details>
<summary><b>🎪 Activity Endpoints</b></summary>
...
<details>
<summary><b>💬 Forum Endpoints</b></summary>
...
<details>
<summary><b>📢 External Info Endpoints</b></summary>
...
<details>
<summary><b>✨ Affirmation Endpoints</b></summary>
